...
The concrete implementation definitions of systems, such as OpenAPI, GraphQL, and SQL, tend to be complicated because they involve many details. On the other hand, ALPS allows you to express the information design that forms the core of the system at a high level of abstraction through semantic descriptions.

This abstract representation makes it possible to communicate efficiently with AI, and facilitates various concrete implementation formats, such as API specifications, database schemas, and type definitions. By using the prompts introduced here, you can efficiently generate various implementation definitions from ALPS.
